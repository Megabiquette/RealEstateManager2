...
class SearchQuery (val types: List<String>, val priceMin: Int, val priceMax: Int, val surfaceMin: Int, val surfaceMax: Int, val neighborhood: String, val POIs: String,
